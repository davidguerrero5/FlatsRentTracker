...
**Note:** When using the free `onboarding@resend.dev` sender, you can only send to your own email. To send to multiple recipients, verify a custom domain at https://resend.com/domains.
